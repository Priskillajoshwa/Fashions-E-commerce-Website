...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{url('public/assets/css/vendor.css')}}">
  ...
  <nav class="navbar navbar-expand-lg bg-light text-uppercase fs-6 p-3 border-bottom align-items-center">
    <div class="container-fluid">
      <div class="row justify-content-between align-items-center w-100">
        ...
        <div class="col-auto">
          <a class="navbar-brand text-white" href="{{url('/index.html')}}">
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome">
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Home Layout 1</a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Home Layout 2 </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Home Layout 3 </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Home Layout 4 </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Shop Sidebar </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Shop Three Column </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Shop Three Column Wide </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Shop Four Column </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Shop Four Column Wide </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Shop Six Column </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Shop Six Column Wide </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Single Product </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Single Product V2 </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownBlog">
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Blog Classic </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Blog Grid with Sidebar </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Blog Grid Four Column </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Blog No Sidebar </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Blog Right Sidebar </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Single Post </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Single Post No Sidebar </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">About </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Cart </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Checkout </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Coming Soon </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Contact </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Error Page </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">FAQs </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">My Account </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Order Tracking </a>
                    </li>
                    <li>
                      <a href="{{url('public/assets/index.html')}}" class="dropdown-item item-anchor">Wishlist </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
        ...
        <div class="col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            <li class="d-none d-lg-block">
              <a href="{{url('public/assets/index.html')}}" class="text-uppercase mx-3">Wishlist <span class="wishlist-count">(0)</span>
              </a>
            </li>
            <li class="d-none d-lg-block">
              <a href="{{url('public/assets/index.html')}}" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
          ...
          <div class="swiper-wrapper d-flex border-animation-left">
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="{{url('public/assets/images/banner-image-6.jpg')}}"  alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="{{url('public/assets/index.html')}}" class="item-anchor">Soft leather jackets</a>
                  </h5>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="{{url('public/assets/images/banner-image-1.jpg')}}"   alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="{{url('public/assets/images/banner-image-2.jpg')}}"  alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="{{url('public/assets/images/banner-image-4.jpg')}}"  alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="{{url('public/assets/index.html')}}" class="item-anchor">Out crop sweater</a>
                  </h5>
                  <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Discover Now</a>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="{{url('public/assets/images/banner-image-5.jpg')}}"  alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img  src="{{url('public/assets/images/cat-item1.jpg')}}" alt="categories" class="product-image img-fluid">
                </a>
              </div>
              <div class="category-content">
                <div class="product-button">
                  <a href="{{url('public/assets/index.html')}}" class="btn btn-common text-uppercase">Shop for men</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/cat-item2.jpg')}}" alt="categories" class="product-image img-fluid">
                </a>
              </div>
              <div class="category-content">
                <div class="product-button">
                  <a href="{{url('public/assets/index.html')}}" class="btn btn-common text-uppercase">Shop for women</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/cat-item3.jpg')}}"  alt="categories" class="product-image img-fluid">
                </a>
              </div>
              <div class="category-content">
                <div class="product-button">
                  <a href="{{url('public/assets/index.html')}}" class="btn btn-common text-uppercase">Shop accessories</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <section id="new-arrival" class="new-arrival product-carousel py-5 position-relative overflow-hidden">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
        ...
        <a href="{{url('public/assets/index.html')}}" class="btn-link">View All Products</a>
      </div>
        ...
        <div class="swiper-wrapper d-flex">
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <a href="{{url('public/assets/index.html')}}">
                  <img  src="{{url('public/assets/images/product-item-1.jpg')}}" alt="categories" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                  </svg>
                </a>
                <div class="product-content">
                  <h5 class="element-title text-uppercase fs-5 mt-3">
                    <a href="{{url('public/assets/index.html')}}">Dark florish onepiece</a>
                  </h5>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-2.jpg')}}"  alt="categories" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                ...
                <div class="product-content">
                  <h5 class="text-uppercase fs-5 mt-3">
                    <a href="{{url('public/assets/index.html')}}">Baggy Shirt</a>
                  </h5>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-3.jpg')}}"  alt="categories" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                ...
                <div class="product-content">
                  <h5 class="text-uppercase fs-5 mt-3">
                    <a href="{{url('public/assets/index.html')}}">Cotton off-white shirt</a>
                  </h5>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-4.jpg')}}"  alt="categories" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                ...
                <div class="product-content">
                  <h5 class="text-uppercase fs-5 mt-3">
                    <a href="{{url('public/assets/index.html')}}">Crop sweater</a>
                  </h5>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-10.jpg')}}" alt="categories" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
      ...
      <div class="row">
        ...
        <div class="collection-item d-flex flex-wrap my-5">
          <div class="col-md-6 column-container">
            <div class="image-holder">
              <img src="{{url('public/assets/images/single-image-2.jpg')}}" alt="collection" class="product-image img-fluid">
            </div>
          </div>
        ...
        <div class="swiper-wrapper d-flex">
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="{{url('public/assets/index.html')}}" class="text-decoration-none" data-after="Add to cart"><span>$95.00</span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-3.jpg')}}" alt="product" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                ...
                <div class="product-content">
                  ...
                  <a href="{{url('public/assets/index.html')}}" class="text-decoration-none" data-after="Add to cart"><span>$55.00</span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img  src="{{url('public/assets/images/product-item-5.jpg')}}" alt="categories" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                ...
                <div class="product-content">
                  ...
                  <a href="{{url('public/assets/index.html')}}" class="text-decoration-none" data-after="Add to cart"><span>$65.00</span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-6.jpg')}}"   alt="categories" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                ...
                <div class="product-content">
                  <h5 class="text-uppercase fs-5 mt-3">
                    <a href="{{url('public/assets/index.html')}}">Handmade crop sweater</a>
                  </h5>
                  <a href="{{url('public/assets/index.html')}}" class="text-decoration-none" data-after="Add to cart"><span>$50.00</span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-9.jpg')}}"  alt="categories" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                ...
                <div class="product-content">
                  ...
                  <a href="{{url('public/assets/index.html')}}" class="text-decoration-none" data-after="Add to cart"><span>$70.00</span></a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="video-content open-up" data-aos="zoom-out">
          <div class="video-bg">
            <img  src="{{url('public/assets/images/video-image.jpg')}}" alt="video" class="video-image img-fluid">
          </div>
          <div class="video-player">
            <a class="youtube" href="https://www.youtube.com/embed/pjtsGzQjFM4">
              ...
              <img  src="{{url('public/assets/images/text-pattern.png')}}"  alt="pattern" class="text-rotate">
            </a>
          </div>
        </div>
      </div>
        ...
        <div class="swiper-wrapper d-flex">
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-5.jpg')}}" alt="product" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-6.jpg')}}" alt="product" class="product-image img-fluid">
                </a>
                <a href="{{url('/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                  </svg>
                </a>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-7.jpg')}}" alt="product" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-8.jpg')}}"  alt="product" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="{{url('public/assets/index.html')}}">
                  <img src="{{url('public/assets/images/product-item-1.jpg')}}" alt="product" class="product-image img-fluid">
                </a>
                <a href="{{url('public/assets/index.html')}}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
  ...
  <section class="blog py-5">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
        ...
        <a href="{{url('public/assets/index.html')}}" class="btn-link">View All</a>
      </div>
      <div class="row">
        <div class="col-md-4">
          <article class="post-item">
            <div class="post-image">
              <a href="{{url('public/assets/index.html')}}">
                <img  src="{{url('public/assets/images/post-image1.jpg')}}" alt="image" class="post-grid-image img-fluid">
              </a>
            </div>
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              ...
              <h5 class="post-title text-uppercase">
                <a href="{{url('public/assets/index.html')}}">How to look outstanding in pastel</a>
              </h5>
        ...
        <div class="col-md-4">
          <article class="post-item">
            <div class="post-image">
              <a href="{{url('public/assets/index.html')}}">
                <img src="{{url('public/assets/images/post-image2.jpg')}}" alt="image" class="post-grid-image img-fluid">
              </a>
            </div>
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              <div class="post-meta text-uppercase fs-6 text-secondary">
              ...
              <h5 class="post-title text-uppercase">
                <a href="{{url('public/assets/index.html')}}">Top 10 fashion trend for summer</a>
              </h5>
        ...
        <div class="col-md-4">
          <article class="post-item">
            <div class="post-image">
              <a href="{{url('public/assets/index.html')}}">
                <img src="{{url('public/assets/images/post-image3.jpg')}}" alt="image" class="post-grid-image img-fluid">
              </a>
            </div>
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              <div class="post-meta text-uppercase fs-6 text-secondary">
              ...
              <h5 class="post-title text-uppercase">
                <a href="{{url('public/assets/index.html')}}">Crazy fashion with unique moment</a>
              </h5>
              <p>Turpis purus, gravida orci, fringilla dignissim lacus, turpis ut suspendisse vel tellus...</p>
            </div>
          </article>
    ...
    <div class="container">
      <div class="row">
        <div class="logo-content d-flex flex-wrap justify-content-between">
          <img  src="{{url('public/assets/images/logo1.png')}}" alt="logo" class="logo-image img-fluid">
          <img src="{{url('public/assets/images/logo2.png')}}" alt="logo" class="logo-image img-fluid">
          <img src="{{url('public/assets/images/logo3.png')}}" alt="logo" class="logo-image img-fluid">
          <img src="{{url('public/assets/images/logo4.png')}}" alt="logo" class="logo-image img-fluid">
          <img src="{{url('public/assets/images/logo5.png')}}" alt="logo" class="logo-image img-fluid">
        </div>
      </div>
    </div>
  </section>

  <section class="newsletter bg-light" style="background: {{url('public/assetsimages/pattern-bg.png')}} no-repeat;">
    <div class="container">
      <div class="row justify-content-center">
      ...
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="https://www.instagram.com/templatesjungle/" target="_blank">
            <img  src="{{url('public/assets/images/insta-item1.jpg')}}" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="https://www.instagram.com/templatesjungle/" target="_blank">
            <img src="{{url('public/assets/images/insta-item2.jpg')}}" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="https://www.instagram.com/templatesjungle/" target="_blank">
            <img src="{{url('public/assets/images/insta-item3.jpg')}}" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="https://www.instagram.com/templatesjungle/" target="_blank">
            <img src="{{url('public/assets/images/insta-item4.jpg')}}" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="https://www.instagram.com/templatesjungle/" target="_blank">
            <img src="{{url('public/assets/images/insta-item5.jpg')}}" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="https://www.instagram.com/templatesjungle/" target="_blank">
            <img src="{{url('public/assets/images/insta-item6.jpg')}}" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="{{url('public/assets/index.html')}}">
                <img  src="{{url('public/assets/images/main-logo.png')}}" alt="logo">
              </a>
            </div>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-002">
            ...
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              <li class="menu-item">
                <a href="{{url('public/assets/index.html')}}" class="item-anchor">Home</a>
              </li>
              <li class="menu-item">
                <a href="{{url('public/assets/index.html')}}" class="item-anchor">About</a>
              </li>
              <li class="menu-item">
                <a href="{{url('public/assets/blog.html')}}" class="item-anchor">Services</a>
              </li>
              <li class="menu-item">
                <a href="{{url('public/assets/styles.html')}}" class="item-anchor">Single item</a>
              </li>
              <li class="menu-item">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-003">
            ...
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              ...
              <li class="menu-item">
                <a href="{{url('public/assets/index.html')}}" class="item-anchor">Faqs</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-wrap">
            <div class="shipping">
              ...
              <img  src="{{url('public/assetsimages/arct-icon.png')}}"  alt="icon">
              <img  src="{{url('public/assets/images/dhl-logo.png')}}" alt="icon">
            </div>
            <div class="payment-option">
              <span>Payment Option:</span>
              <img  src="{{url('public/assets/images/visa-card.png')}}" alt="card">
              <img  src="{{url('public/assets/images/paypal-card.png')}}" alt="card">
              <img  src="{{url('public/assets/images/master-card.png')}}" alt="card">
            </div>
          </div>
