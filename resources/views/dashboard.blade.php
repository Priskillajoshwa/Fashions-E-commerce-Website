...
<body>
	<div class="total-content">
		...
		<div class="col-md-9 content">
			<div class="home-strip">
				<div class="view">
					<ul>
						<li><a href="{{url('public/assetsadmin/index.html')}}"><i class="refresh"></i></a></li>
						...
						<li>
								  <div id="dd1" class="wrapper-dropdown-1"><i class="msgs"></i><span class="red">3</span>
									<ul class="dropdown">
										...
										<li><a href="#">
										   <div class="user_img"><img src="{{url('public/assetsadmin/images/avatar2.jpg')}}" alt=""></div>
										 ...
										 <li class="odd"><a href="#">
										    <div class="user_img"><img src="{{url('public/assetsadmin/images/avatar.jpg')}}" alt=""></div>
										   <div class="notification_desc">
										   	<p>Lorem ipsum dolor sit amet </p>
										   	<p><span>1 hour ago</span></p>
										   	</div>
										 ...
										 <li><a href="#">
										   <div class="user_img"><img src="{{url('public/assetsadmin/images/avatar1.jpg')}}" alt=""></div>
										   <div class="notification_desc">
										   	<p>Lorem ipsum dolor sit amet </p>
										   	<p><span>1 hour ago</span></p>
										   	</div>
			...
			<script type="{{url('public/assetsadmin/text/javascript')}}">
				...
				<div class="member">
					...
					<div id="dd" class="wrapper-dropdown-2" tabindex="1"><span><img src="{{url('public/assetsadmin/images/settings.png')}}"/></span>
							<ul class="dropdown">
	...
	<ul class="cd-tabs-content">
		...
		<div class="top-men">
			<div class="men">
				<div class="grid-men">
					<a href="#"><img src="{{url('public/assetsadmin/images/pp.jpg')}}" class="img-responsive" alt=""> </a>
				</div>
				<div class="men-grid">
			...
			<div class="men">
				<div class="grid-men">
					<a href="#"><img src="{{url('public/assetsadmin/images/pp0.jpg')}}" class="img-responsive" alt=""> </a>
				</div>
				<div class="men-grid">
			...
			<div class="men">
				<div class="grid-men">
					<a href="#"><img src="{{url('public/assetsadmin/images/pp01.jpg')}}" class="img-responsive" alt=""> </a>
				</div>
				<div class="men-grid">
					<h6>on<a href="#"> Fashion News</a> / by <a href="#">Jolia</a></h6>
					<span>12-11-2014</span>
